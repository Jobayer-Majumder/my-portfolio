...
const projectData = [
    {
        name: 'The Car Doctor',
        desc: 'A MERN Stack And Responsive Service Seller Web Application With Admin Panel. Admin can see all order list, delete services, add services and make admin option. Normal user can buy services by stripe payment system, also review option available for user',
        img: theCarDoctor,
        liveLink: 'https://the-car-doctor-s.web.app/',
        gitLink: 'https://github.com/Jobayer-Majumder/the-car-doctor',
